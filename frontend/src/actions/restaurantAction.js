import { ALL_RESTAURANTS_FAIL,ALL_RESTAURANTS_REQUEST, 
  ALL_RESTAURANTS_SUCCESS,SORT_BY_RATINGS,
  SORT_BY_REVIEWS,TOGGLE_VEG_ONLY,
  CLEAR_ERROR} from "../constants/restaurantConstant"
